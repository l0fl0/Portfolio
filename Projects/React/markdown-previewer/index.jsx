...
function MarkdownPreviewer() {
  ...
  const stylesForMaximizeOnClick = editorWindow
    ? [
        "editor maximized maximizeTextarea",
        "previewer hide",
        "fa fa-compress-alt",
        "Minimize Window",
        "maximizeTextarea",
...
const placeholder = ` placeholder text from Marked [demo](https://marked.js.org/demo/) page under the quick reference selector. 
...
[Happy]: https://www.goodfreephotos.com/albums/other-photos/smiley-face-basic.jpg (smiley face!)
